...
(library Library_1
	...
	(patternDef "SHDR3W50P0X150_1X3_600X350X450" (originalName "SHDR3W50P0X150_1X3_600X350X450")
		...
		(layerContents (layerNumRef 28)
			(line (pt 1.5 -1.3) (pt -4.5 -1.3) (width 0.1))
		)
		(layerContents (layerNumRef 28)
			(line (pt -4.5 -1.3) (pt -4.5 2.2) (width 0.1))
		)
		(layerContents (layerNumRef 28)
			(line (pt -4.5 2.2) (pt 1.5 2.2) (width 0.1))
		)
		(layerContents (layerNumRef 28)
			(line (pt 1.5 2.2) (pt 1.5 -1.3) (width 0.1))
		)
		(layerContents (layerNumRef 18)
	...
	(compDef "B3B-ZR_LF__SN_" (originalName "B3B-ZR_LF__SN_") (compHeader (numPins 3) (numParts 1) (refDesPrefix J)
		...
		(attr "Datasheet Link" "http://www.jst-mfg.com/product/pdf/eng/eZH.pdf")
		(attr "Height" "4.5 mm")
	)
