...
(library Library_1
	...
	(patternDef "NHD0216XZFSWGBW" (originalName "NHD0216XZFSWGBW")
		...
		(layerContents (layerNumRef 28)
			(line (pt -40 18) (pt 40 18) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 40 18) (pt 40 -18) (width 0.025))
		)
	...
	(compDef "NHD-0216XZ-FSW-GBW" (originalName "NHD-0216XZ-FSW-GBW") (compHeader (numPins 20) (numParts 1) (refDesPrefix DS)
		...
		(compPin "17" (pinName "MH1") (partNum 1) (symPinNum 17) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "18" (pinName "MH2") (partNum 1) (symPinNum 18) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "19" (pinName "MH3") (partNum 1) (symPinNum 19) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "21" (pinName "MH4") (partNum 1) (symPinNum 20) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(attr "<Hyperlink>" "http://www.newhavendisplay.com/specs/NHD-0216XZ-FSW-GBW.pdf")
		(attr "<Component Height>" "7")
		(attr "<STEP Filename>" "NHD-0216XZ-FSW-GBW.stp")
