...
(library Library_1
	...
	(compDef "TLP521-1GB" (originalName "TLP521-1GB") (compHeader (numPins 4) (numParts 1) (refDesPrefix IC)
		...
		(compPin "4" (pinName "D2") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "3" (pinName "D1") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(attr "Datasheet Link" "https://datasheet.lcsc.com/szlcsc/Isocom-Components-TLP521GB_C69256.pdf")
		(attr "Height" "4.5 mm")
	)
