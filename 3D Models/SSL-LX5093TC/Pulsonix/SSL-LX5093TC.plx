...
(library Library_1
	...
	(patternDef "SSL-LX5093SGC/B" (originalName "SSL-LX5093SGC/B")
		(multiLayer
			(pad (padNum 1) (padStyleRef c140_h91) (pt 1.27, 0) (rotation 90))
			(pad (padNum 2) (padStyleRef c140_h91) (pt -1.27, 0) (rotation 90))
		)
		(layerContents (layerNumRef 18)
			(attr "RefDes" "RefDes" (pt -0.497, -0.097) (textStyleRef "Normal") (isVisible True))
		)
		...
		(layerContents (layerNumRef 28)
			(line (pt 2.365 1.733) (pt 2.365 -1.748) (width 0.025))
		)
		(layerContents (layerNumRef 18)
			(line (pt 2.365 -1.748) (pt 2.365 1.733) (width 0.2))
		)
		(layerContents (layerNumRef 18)
			(arc (pt 3.515, -0.01) (radius 0) (width 0.2))
		)
	)
	...
	(compDef "SSL-LX5093TC" (originalName "SSL-LX5093TC") (compHeader (numPins 2) (numParts 1) (refDesPrefix LED)
		...
		(attachedPattern (patternNum 1) (patternName "SSL-LX5093SGC/B")
			(numPads 2)
			(padPinMap
		...
		(attr "<Hyperlink>" "http://www.lumex.com.tw/spec/SSL-LX5093TC.pdf")
		(attr "<STEP Filename>" "SSL-LX5093TC.stp")
		(attr "<STEP Offsets>" "X=0.04;Y=0;Z=7.07")
